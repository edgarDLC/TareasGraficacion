...
export class CanvasLocal {
    ...
    */
    ...
    barra(x, y, alt, color, porcentaje) {
        ...
        this.rellenar(p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, p4.x, p4.y, this.colorOscuro(color, 30), 'black');
        // 2. Segunda área der colors normal
        this.rellenar(p1.x, p1.y, p4.x, p4.y, p5.x, p5.y, p6.x, p6.y, color, 'black');
        // 3. Tercera área izq gris oscuro
        this.rellenar(p3.x, p3.y, p4.x, p4.y, p9.x, p9.y, p7.x, p7.y, 'lightgray', 'black');
        // 4. Cuarta área der blanco normal
        this.rellenar(p4.x, p4.y, p10.x, p10.y, p9.x, p9.y, p5.x, p5.y, 'white', 'black');
    ...
    paint() {
        ...
        for (let i = 0; i <= numIntervalos; i++) {
            ...
            // Mostrar el valor
            this.graphics.strokeText(Math.round(yValue).toString(), this.iX(-0.8), this.iY(yPos));
        }
    }
}
